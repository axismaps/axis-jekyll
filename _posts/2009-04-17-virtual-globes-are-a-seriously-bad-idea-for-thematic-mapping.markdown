...
<p style="padding-left: 30px;"><strong> </strong>Hard, isn't it? To be honest, it shouldn't be: A regular 2D classed choropleth map or proportional symbol map would make short work of those questions. So what did we gain by extruding the countries up into space? Not much that I can see.<br /></p>
