...
<p>[caption id="attachment_1920" align="aligncenter" width="667"]<a href="http://store.axismaps.com/product/boston"><img class="wp-image-1920 size-full" src="http://www.axismaps.com/blog/wp-content/uploads/2014/11/boston_full.png" alt="boston_full" width="667" height="1000" /></a> <em>Boston 2nd ed. typographic map</em>[/caption]</p>
...
<p>Fitting more territory on the same-sized poster meant a smaller scale map, which in turn called forÂ some design modifications. For example, because streets were crunched closer together at the new scale we reduced font sizes. The smallest text on the map is that ofÂ residential streets -- now just 6pt in size. It's still readable yet small enough to prevent excessive overlap in the denser parts of the city. We also removed the underlying neighborhoods layer that existed in the original version. Again, due to the smaller scale, it cluttered the map and was mostly buried by streets anyway.</p>
<h3>Area Features</h3>
...
<p>We've liked the wavy water text style ever since we first applied it to the <a title="Chicago poster" href="http://store.axismaps.com/product/typographic-map-chicago-color">Chicago map</a>. Variation in text size, placement along curving paths that parallel one another, and the use of opacity masking to give the appearance of overlapping waves all come together to representÂ the flow and movement of water better than any other technique we know. We hope the redesigned water text in the 2nd edition map does the same.</p>
<h3>Tunnels</h3>
<p>Boston is famous for its major underground and underwater tunnels. The 2nd edition Boston map is the firstÂ to employ a text style specifically for tunnels. Where highway text goes subsurface, we simply reverse its fill and stroke color. For example, Interstate 90 is represented by purple text with a white stroke but where it becomes Ted Williams Tunnel it is reversed and becomesÂ white text with a purple stroke. I can't help but compareÂ the bright white tunnel text to the bright lights of cars being turned on as they go beneath the surface.</p>
<p>Below areÂ images of the two maps side by side, each covering an area that is approximately 13 by 13 inches on the printed poster. The 2nd ed. covers a lot more ground in the same amount of space, has a bolder look due in part to itsÂ color-filled areas, has wavy water text, and a couple of new headlight-style tunnels. Let's say goodbye to the original Boston map and hello to the <a title="Boston 2nd edition" href="http://store.axismaps.com/product/boston">2nd edition</a>!</p>
<p>[caption id="attachment_1919" align="aligncenter" width="800"]<a href="http://store.axismaps.com/product/boston"><img class="wp-image-1919 size-full" src="http://www.axismaps.com/blog/wp-content/uploads/2014/11/boston_2ed.png" alt="Boston 2nd ed. typographic map detail" width="800" height="800" /></a> <em>Boston 2nd ed. typographic map detail</em>[/caption]</p>
<p>[caption id="attachment_1921" align="aligncenter" width="800"]<a href="http://store.axismaps.com/product/boston"><img class="wp-image-1921 size-full" src="http://www.axismaps.com/blog/wp-content/uploads/2014/11/boston_type_0329_02_blog.jpg" alt="Original Boston typographic map detail" width="800" height="800" /></a> <em>Original Boston typographic map detail</em>[/caption]</p>
