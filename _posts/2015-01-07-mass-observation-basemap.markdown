...
<p class="p1">Finally, our background texture was made using scanned images of folded paper and cardboard. After a good bit of trial and error, we worked up a seamless version of the image in Photoshop that could be repeated throughout the map.<a href="http://www.axismaps.com/blog/wp-content/uploads/2014/12/texture.png"><img class="aligncenter wp-image-1965 size-large" src="http://www.axismaps.com/blog/wp-content/uploads/2014/12/texture-1024x1024.png" alt="texture" width="660" height="660" /></a></p>
