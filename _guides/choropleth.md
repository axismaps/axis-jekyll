...
_**Not sure you should use a choropleth map?**_ Good alternatives include [dot density maps](../dot_density), [graduated/proportional symbol](../proportional_symbols) maps, and [cartograms](../cartograms): Furthermore, while choropleth maps require that your data are standardized (rates, ratios...e.g., _X per square kilometer_ or _Y per 100,000 people_), these other 3 map types can all handle raw data (e.g., simple counts, totals).

### Example Classed Choropleth Map

Below is a 5-class choropleth map that uses a [sequential color scheme](../color_schemes) (from light to dark) attached to an equal-interval classification scheme.
...
![]({{site.baseurl}}/media/guides/unclassed_ramp.jpg)
...
![]({{site.baseurl}}/media/guides/unclassed_choropleth_map.jpg)
