...
<p>[caption id="attachment_33" align="alignnone" width="300" caption="Mock-up of an opaque, 7-class choropleth map for Maker! (Google terrain)"]<a href="{{ site.baseurl }}/media/posts/2008/08/picture-9.png"><img class="size-medium wp-image-33" title="picture-9" src="{{ site.baseurl }}/media/posts/2008/08/picture-9-300x272.png" alt="Mock-up of an opaque, 7-class choropleth map for Maker! (Google terrain)" width="300" height="272" /></a>[/caption]</p>
<p>[caption id="attachment_34" align="alignnone" width="300" caption="Same mock-up, at 50% opaque (Google terrain) "]<a href="{{ site.baseurl }}/media/posts/2008/08/picture-10.png"><img class="size-medium wp-image-34" title="picture-10" src="{{ site.baseurl }}/media/posts/2008/08/picture-10-300x272.png" alt="Same mock-up, at 50% opaque (Google terrain)" width="300" height="272" /></a>[/caption]</p>
<p>[caption id="attachment_35" align="alignnone" width="300" caption="Same mock-up, at 50% opaque (Google streets)"]<a href="{{ site.baseurl }}/media/posts/2008/08/picture-11.png"><img class="size-medium wp-image-35" title="picture-11" src="{{ site.baseurl }}/media/posts/2008/08/picture-11-300x272.png" alt="Same mock-up, at 50% opaque (Google streets)" width="300" height="272" /></a>[/caption]</p>
<p>[caption id="attachment_36" align="alignnone" width="300" caption="Same mock-up, at 50% opaque (Google satellite)"]<a href="{{ site.baseurl }}/media/posts/2008/08/picture-12.png"><img class="size-medium wp-image-36" title="picture-12" src="{{ site.baseurl }}/media/posts/2008/08/picture-12-300x272.png" alt="Same mock-up, at 50% opaque (Google satellite)" width="300" height="272" /></a>[/caption]</p>
...
<p>[caption id="attachment_37" align="alignnone" width="400" caption="Screen-shot from Maker! showing opaque choropleth unit boundaries"]<a href="{{ site.baseurl }}/media/posts/2008/08/picture-31.png"><img class="size-full wp-image-37" title="picture-31" src="{{ site.baseurl }}/media/posts/2008/08/picture-31.png" alt="Screen-shot from Maker! showing opaque choropleth unit boundaries" width="400" height="300" /></a>[/caption]</p>
<p>[caption id="attachment_38" align="alignnone" width="245" caption="Corresponding legend for the above map"]<a href="{{ site.baseurl }}/media/posts/2008/08/picture-14.png"><img class="size-full wp-image-38" title="picture-14" src="{{ site.baseurl }}/media/posts/2008/08/picture-14.png" alt="Corresponding legend for the above map" width="245" height="249" /></a>[/caption]</p>
...
<p>[caption id="attachment_196" align="alignnone" width="500" caption="GeoCommons Maker! Data Probe"]<a href="{{ site.baseurl }}/media/posts/2008/12/picture-51.png"><img class="size-full wp-image-196" title="picture-51" src="{{ site.baseurl }}/media/posts/2008/12/picture-51.png" alt="GeoCommons Maker! Data Probe" width="500" height="338" /></a>[/caption]</p>
...
<p>[caption id="attachment_41" align="alignnone" width="191" caption="Screen-shot from Maker! showing the transparency control"]<a href="{{ site.baseurl }}/media/posts/2008/08/picture-131.png"><img class="size-full wp-image-41" title="picture-131" src="{{ site.baseurl }}/media/posts/2008/08/picture-131.png" alt="Screen-shot from Maker! showing the transparency control" width="191" height="202" /></a>[/caption]</p>
