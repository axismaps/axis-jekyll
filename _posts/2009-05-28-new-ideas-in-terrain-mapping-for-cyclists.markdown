...
---
<p style="text-align: center;"><img class="size-full wp-image-452 aligncenter" src="/media/posts/2009/05/danielbio1.png" alt="danielbio1" width="525" height="79" /></p>
...
![Figure 1: The above is a draft of one of my first attempts, in this case depicting a particular ride that one of my roommates hopes to participate in this summer. click to see fullsize](/media/posts/2009/05/fig13.png)
...
![Figure 2: Using the visual variables of lightness or size to encode data](/media/posts/2009/05/fig2.png)
...
![Figure 3: The arrow points downhill, and larger arrows or darker ones indicate steeper slopes.](/media/posts/2009/05/fig3.png)
